...
<![endif]-->
  ...
  <body>
    ...
    <section id="container" class="">
	  ...
	  <!--
	  <a href="<?php echo U('person')?>">
        <div class="sidebar-toggle-box">
          <div  data-placement="right" class="fa fa-arrow-circle-o-left" style="font-size: 20px;color: #ffffff;margin-top: 6px;">
          Back
          </div>
        </div>
        </a>
		...
		<!-- SIDEBAR TOGGLE BUTTON  END-->
			...
			<center><div style="font-size:25px;color:#ffffff;margin-top: 13px;"> 关注</div></center>
              ...
              <section class="panel" >
                ...
                <ul class="list-group alt">
                  <li class="list-group-item">
                    <div class="media">
                      <span class="pull-left thumb-sm">
                        <a href="<?php echo U('StudentAbroad/LookPerson')?>"><img src="/wechat/Public/Olive/img/chat-avatar2.jpg" alt="John said" class="img-circle"></a>
                      </span>
                      ...
                      <div class="media-body">
                        <div>
                        <button class="btn btn-info" style="float: right;width: 80px;">取消关注</button>
                          <a href="#">
                            Pruthvi Bardolia
                          </a>
                        </div>
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <span class="pull-left thumb-sm">
                        <img src="/wechat/Public/Olive/img/chat-avatar.jpg" alt="John said" class="img-circle">
                      </span>
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <span class="pull-left thumb-sm">
                        <img src="/wechat/Public/Olive/img/chat-avatar2.jpg" alt="John said" class="img-circle">
                      </span>
