	...
	<div class="modal-dialog">
		<div class="modal-content">
            ...
            <div class="form-group">
                ...
                <input size="16" type="text"  readonly class="form_datetime form-control" placeholder="Begin Time">
            ...
            <div class="form-group">
                ...
                <input size="16" type="text"  readonly class="form_datetime form-control" placeholder="End Time">
