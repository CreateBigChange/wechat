...
<![endif]-->
  ...
  <body>
              ...
              <aside class="profile-nav alt green-border">
                <section class="panel">
                  <div class="user-heading alt green-bg">
                    <a href="#">
                      <img alt="" src="/wechat/Public/Olive/img/profile-avatar.jpg">
                    </a>
                    <h1>
                      Pruthvi Bardolia
                    </h1>
                    <p>
                      pruthvi@tripzmate.com
                    </p>
                  </div>
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li>
                      <a href="javascript:;">
                        ...
                        同伴信息 
                        <span class="label label-success pull-right r-activity">
                          10
                        </span>
                      </a>
                    </li>
    ...
    <script src="/wechat/Public/Olive/s/common-scripts.js" ></script><!-- BASIC COMMON JS  -->
    <script >
      $(".knob").knob();
    </script>
    <!-- END  JQUERY -->
