...
*/
            ...
            <div class="modal-footer" style="clear:both;">
                ...
                <button type="button" class="btn btn-info model_font">submit</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
...
<div class="modal fade" id="repeal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" >
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel" style="font-size:48px;">repeal</h4>
            </div>
            <div class="modal-body" style="font-size:38px;">are you sure repeal the Acticity?</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-info" data-dismiss="modal" style="font-size:38px;width:150px;">No</button>
                <button type="button" class="btn btn-default" style="font-size:38px;width:150px;">Yes</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
...
<div class="body">
	...
	<div class="detail">
		...
		<div class="time common">13 May 2017 , 9:00-12:00 <button style="float:right;font-size: 38px;" class="btn btn-error"  data-toggle="modal" data-target="#repeal">repeal</button></div>
		<div class="price common">¥20 <div class="password">key:183002155</div></div>
		...
		<div class="detail_content common"><span style="letter-spacing:2px;">content</span>:本次的活动请带好手机和相关的活动物品，大家7点准时到哦</div>
                                 ...
                                 <div class="message-body msg-in" style="margin-left:200px;">
                                    ...
                                    <div class="text" style="overflow:hidden">
                                       ...
                                       <p style="font-size:38px;" id="contentpanel" >
                        				...
                        				<a   href="javascript:void(0)" style="font-size:35px;float: right;color:#58C9F3;" class="deloay">unfold </a> 
