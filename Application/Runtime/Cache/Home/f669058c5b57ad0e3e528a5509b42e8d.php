...
<!--modal-->
	...
	<div class="lg-container" style="width:80%;" >
		...
		<form action="" id="lg-form" name="lg-form" method="post">
			...
			<img src="/wechat/Public/resouce/img/u=5599099874283859303&fm=21&gp=0.png" style="width:50px;float:right;margin-top:15px;margin-right: 10px;" data-toggle="modal" data-target="#direction"/>
