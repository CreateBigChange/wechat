...
.rating-gly {
 ...
 <body style="font-size: 36px;">
    ...
    <header class="index-3O8rT">
     <div class="index-MAORp">
        <div class="index-3vsmj">
           ...
           <span class="index-1cnKa">湖南科技大学逸夫楼</span>
    ...
    <div class="foodentry-wrapper"  id="selectContent">

        <div id="sort" style="width: 50%;float: left;text-align: center;border-right: 1px solid #E6E6E6;font-size:50px;height: 130px;line-height: 130px;">排序</div>

        <div id="selectItem" style="width: 50%;float: left;text-align: center;font-size:50px;height: 130px;line-height: 130px;">筛选</div>
