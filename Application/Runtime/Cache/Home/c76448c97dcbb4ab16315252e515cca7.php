...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <title>Olive Admin | Email Templates </title>
      <!--IMPORTANT: 
      ...
      <style type="text/css">
         ...
         ***/
         ...
         .btn.green td:focus, 
         .btn.green td:active { 
         background: #5cb534 !important;
         }
         /*  Blue */
         .btn.blue td {
         background: #217d98 !important;
         }
         .btn.blue td:hover, 
         .btn.blue td:focus, 
         .btn.blue td:active {  
         background: #0b6984 !important;
         }
         .template-label {
         color: #ffffff;
         font-weight: bold;
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="margin-top:200px;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel" style="text-align: center;">FeedBack</h4>
            </div>
            ...
            <form role="form">
              <div class="form-group">
                ...
                <textarea class="form-control" rows="3" placeholder="please discribe your problem in detail"></textarea>
              </div>
            </form>
   ...
   <img src="/wechat/Public/resouce/img/timg.jpg"  style="width:50px;position:fixed;top: 90%;left:83%;" data-toggle="modal" data-target="#myModal"/>
      <!-- TABLE .BODY START  -->
      <table class="body">
         <tr>
            <td class="center" align="center" valign="top">
               ...
               <!-- BEGIN: Header -->
               <table class="page-header" align="center" style="margin-top: 30px;">
                  <tr>
                     <td class="center" align="center" style="background:#ffffff;color:#72d0eb;font-size:28px;line-height: 40px; ">
               ...
               <table class="container content" align="center" >
                  <tr>
                     <td>
                        <table class="row" style="margin:0px;">
                           <tr>
                              <td class="wrapper last">
                                 ...
                                 <table class="twelve columns">
                                    <tr>
                                       <td>
                                          <h4>This is a Responsive Email Template</h4>
                                          <p>
